...
$(document).ready(function () {
    ...
    function init_template() {
        ...
        setTimeout(function () {
            ...
            $('.f-slider').owlCarousel({ rtl: true, loop: true, margin: 0, nav: false, lazyLoad: false, items: 2, autoplay: false, autoplayTimeout: 4000 });
        ...
        $('.input-required input, .input-required select, .input-required textarea').on('focusin keyup', function () {
            ...
            if ($(this).val() != spanValue && $(this).val() != "") {
                ...
                $(this).parent().find('span').addClass('focus-act');
            }
            if ($(this).val() === "") {
        ...
        $('.input-required input.flatpickr').on('focusin keyup', function () {
            ...
            if ($(this).val() != spanValue && $(this).val() != "") {
                $(this).parent().find('span').addClass('input-style-1-active').removeClass('input-style-1-inactive');
                $('input.flatpickr-input').removeClass('color-trn');
            }
            if ($(this).val() === "") {
                $(this).parent().find('span').removeClass('input-style-1-inactive input-style-1-active');
                $('input.flatpickr-input').addClass('color-trn');
            }
        });
        $('.input-required input, .input-required select, .input-required textarea').on('focusout', function () {
            ...
            if ($(this).val() === "") {
                $(this).parent().find('span').removeClass('input-style-1-inactive input-style-1-active');
                $(this).parent().find('span').removeClass('focus-act');
            }
